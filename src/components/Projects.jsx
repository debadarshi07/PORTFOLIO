...
const Projects = () => {
  return (
    <div className="border-b border-neutral-600 pb-4">
        <motion.h1 whileInView={{opacity: 1, y: 0}} initial={{opacity: 0, y: -100}} transition={{duration: 0.5}} className="my-20 text-center text-4xl"><span className="bg-gradient-to-r from-pink-200 via-sky-200 to-purple-200 bg-clip-text text-transparent">Projects</span></motion.h1>
        <div>
