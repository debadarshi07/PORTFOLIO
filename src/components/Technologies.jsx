...
const Technologies = () => {
  return (
    <div className="border-b border-neutral-600 pb-24">
        <motion.h1 whileInView={{opacity: 1, y: 0}} initial={{opacity: 0, y: -100}} transition={{duration: 1.5}} className="my-20 text-center text-5xl"><span className="bg-gradient-to-r from-pink-200 via-emerald-200 to-purple-200 bg-clip-text text-transparent">Technologies</span></motion.h1>
